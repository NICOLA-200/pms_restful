...
const ParkingSlot = React.lazy(() => import('@/pages/parkingSlot/parkingSlot'))
const RequestSlot = React.lazy(() => import('@/pages/requestSlot/requestSlot'))
        ...
        <BrowserRouter>
            <Layout>
                <Routes>
                    ...
                    <Route path="/" element={ isLoggedIn ? <Home /> : <Navigate to={"/auth/signup"}/> } />
